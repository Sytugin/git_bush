# 📌 Работа с git и bash
## Содержание
- [Работа с файлами и папками в bash](#task-1)
- [Поиск и редактирование файлов, работа с процессами, проверка доступности сервера, передача данных на сервер в bash](#task-2)
## Задание 1
